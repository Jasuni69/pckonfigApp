...
async def scrape_ram():
    url_template = "https://www.webhallen.com/se/category/66-RAM-minne?page={}"
    scraped_data = []
    page_number = 1
    ...
    async with async_playwright() as p:
        ...
        while True:
            ...
            await page.goto(url)
            await asyncio.sleep(3)  # Ensure the page is fully loaded
