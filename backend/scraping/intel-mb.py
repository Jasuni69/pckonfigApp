...
async def scrape_intel_motherboards():
    url = "https://www.webhallen.com/se/category/76-Moderkort?f=attributes%5Ecustom.cnet_moderkort_processor_socket_787-1-LGA1851-uttag~LGA1700-uttag"
    scraped_data = []
    ...
    output_file = "intel_motherboards.json"
...
if __name__ == "__main__":
    asyncio.run(scrape_intel_motherboards())
