...
async def scrape_amd_gpus():
    url_template = "https://www.webhallen.com/se/category/47-Grafikkort-GPU?f=attributes%5Ecustom.cnet_videoutgang_chiptillverkare_906-1-AMD%20Radeon&page={}"
    scraped_data = []
    page_number = 1
