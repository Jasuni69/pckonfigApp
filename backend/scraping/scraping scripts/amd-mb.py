...
async def scrape_motherboards():
    url = "https://www.webhallen.com/se/category/76-Moderkort?f=attributes%5Ecustom.cnet_moderkort_processor_socket_787-1-Socket%20AM4~Socket%20AM5~Socket%20sTR5"
    scraped_data = []
    ...
    output_file = "amd_motherboards.json"
...
if __name__ == "__main__":
    asyncio.run(scrape_motherboards())
