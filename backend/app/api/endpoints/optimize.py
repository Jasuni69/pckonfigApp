...
async def optimize_build(
    ...
    try:
        ...
        try:
            ...
            # For FastAPI validation, either we need to populate ALL required fields or set to None
            # Let's set component fields to None to avoid validation errors
            selected_cpu = None
            selected_gpu = None
            ...
            return {
                ...
                # Add individual components to the response (set to None to avoid validation errors)
                "cpu": selected_cpu,
                "gpu": selected_gpu,
